In my view, the main technical issues are:

* Fixing the variation methods

* Visually inspecting the three networks (pud, ego depletion, and tobacco) to see if there are any suspicious features

If the networks are okay, then we can proceed to simulations.


Of course, in the meantime we can improve the paper. Especially, given the feedback from FEW:

*  I would have appreciated more detail on why the results change – what is it about the empirical networks that is different from the simple theoretical networks that makes it so the Zollman effect and equality effect no longer hold?

* What are we supposed to learn about the dynamics of inquiry from these results?

* I would have also appreciated more clarity on how this gets us closer to a ‘how actually’ model. What is the phenomenon we are actually explaining and how have we gotten closer to explaining it?
